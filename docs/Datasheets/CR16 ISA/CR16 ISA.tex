...
B[condition] & Displacement Imm & \code{Relative jump by Imm if [condition]} & 1101 & condition & ImmHi & ImmLo & Immediate is used as a 2's complement program counter/address displacement. [condition] bit patterns are in Table 1 in Original CR16 ISA \\ \hline
J[condition] & Rtarget & \code{Absolute jump to Rtarget if [condition]} & 1111 & condition & 0010 & Rtarget & [condition] bit patterns are in Table 1 in Original CR16 ISA \\ \hline
